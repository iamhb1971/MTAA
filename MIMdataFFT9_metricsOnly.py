...
if __name__ == '__main__':
    ...
    dir2walkthru=r'C:\\Users\\307984\\Downloads\\MX350\\Multi_TAA\\'
    ...
    if 1:
        ...
        file_metrics = open('C:\\Users\\307984\\Downloads\\TAAmetrics04Jun.csv', 'w')
        ...
        for filename in resultFilelist:
                    ...
                    amplitudeMetrics=[max(TAAdata),min(TAAdata),TAAdata.index(max(TAAdata)),TAAdata.index(min(TAAdata)),np.std(TAAdata),max(TAAdata)-min(TAAdata)]
                    
                    for k in harmonics:
                        file_metrics.writelines(str(round(k,2)))
                        file_metrics.writelines(',')

                    for k in amplitudeMetrics:
                        file_metrics.writelines(str(round(k,2)))
                        file_metrics.writelines(',')
